...
const Skills = () => {
  return (
    ...
    <div className='border border-gray-600 bg-black text-gray-400 md:h-[150px] max-w-[1200px] mx-auto grid grid-col-6 place-items-center md:flex md:justify-between md:items-center'>
